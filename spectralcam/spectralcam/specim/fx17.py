...
class FX17(FXBase):
  """Class to provide easy Python interface for Specim FX17e."""

  DEV_INFO_VENDOR = "Specim"
  DEV_INFO_MODEL = "FX17e"
  ...
  def set_defaults(self, frame_rate: float = 20.0, exposure_time: float = 2000.0) -> None:
    ...
    frame_rate_mode = self.get("AcquisitionFrameRateMode")
    if frame_rate_mode != "ExposureControlled":
      self.set("AcquisitionFrameRateMode", "ExposureControlled")
...
if __name__ == "__main__":
  ...
  # Find connected FX17 camera automatically (more or less)
  system = GCSystem()
